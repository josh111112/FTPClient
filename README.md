...
| Remote directory listing (`ls`)                  | 3      |
| Changing remote directory (`cwd`)                | 2      |
...
| Error handling: downloading non-existing file    | 2      |
| Error handling: uploading non-existing file      | 2      |
